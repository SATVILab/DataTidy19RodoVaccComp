...
The raw data are kept in the release `input` on GitHub, and must be saved to the `data-raw` directory (as specified in `_projr.yml`) to run the data.
...
knitr::include_graphics(
  projr::projr_path_get("data-raw", "img", "Data_Prep_Flow.png")
)
```
