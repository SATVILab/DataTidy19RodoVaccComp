...
dataprepPath = projr::projr_dir_get(
  "project", "scripts", "R", "dataprep"
)
dirFunc = function(x) paste0(dataprepPath, "/", x)
devtools::load_all()
source(file = "scripts/R/dataprep/libraries.R")
...
usethis::use_data(bl17ExcTbl, overwrite = TRUE)
usethis::use_data(bl17ExcITbl, overwrite = TRUE)
usethis::use_data(join17ExcTbl, overwrite = TRUE)
usethis::use_data(join17ExcITbl, overwrite = TRUE)
usethis::use_data(join17IncITbl, overwrite = TRUE)
usethis::use_data(megITbl, overwrite = TRUE)
usethis::use_data(sub17ExcTbl, overwrite = TRUE)
usethis::use_data(sub17ExcITbl, overwrite = TRUE)
usethis::use_data(tmax17ExcTbl, overwrite = TRUE)
usethis::use_data(tmax17ExcITbl, overwrite = TRUE)
usethis::use_data(tmaxSub17ExcTbl, overwrite = TRUE)
usethis::use_data(tmaxSub17ExcITbl, overwrite = TRUE)
usethis::use_data(blSingle17Tbl, overwrite = TRUE)
usethis::use_data(single17Tbl, overwrite = TRUE)
usethis::use_data(single17ITbl, overwrite = TRUE)
usethis::use_data(tmaxSingle17Tbl, overwrite = TRUE)
usethis::use_data(tmaxSingle17ITbl, overwrite = TRUE)
usethis::use_data(subSingle17Tbl, overwrite = TRUE)
usethis::use_data(subSingle17ITbl, overwrite = TRUE)
usethis::use_data(tmaxSubSingle17Tbl, overwrite = TRUE)
usethis::use_data(tmaxSubSingle17ITbl, overwrite = TRUE)
