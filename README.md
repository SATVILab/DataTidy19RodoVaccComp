...
cells producing some combination of the cytokines IFN$\gamma$, IL-2 and
TNF. All raw data except that in the file megapool.csv also include
IL-17, and the file bcg.xlsx also included IL-22.
...
- Columns
  ...
  - CD4+2+17+G+T+ to CD8+2-17-G-T+
    ...
    - 2\[+/-\]17\[+/-\]G\[+/-\]T\[+/-\] indicates the cytokine
      ...
      IFN$\gamma$ and ‘T’ to TNF. A ‘+’ indicates that the preceding
...
- Columns
  ...
  - CD\[4/8\]+/2+ to CD\[4/8\]+/2-17-22-g-T-
    ...
    - CD\[4/8\]+ indicates whether cells are CD4 or CD8 T cells.
    - ‘2’ corresponds to IL-2, ‘17’ to IL-17, ‘G’ to IFN$\gamma$, ‘T’ to
      TNF and ‘22’ to IL-22. A ‘+’ indicates that the preceding cytokine
      was produced, and a ‘-’ that it was not.
- Responses background subtracted?
  - No
...
below. THe first, h1-group_info.xlsx, was used to determine which study
...
- Columns
  ...
  - Vaccine/Placebo
    ...
    - ‘vaccine’ means that the participant was given a vaccine, and
      ‘placebo’ that the participant was given a placebo.
  - Dose: dose size.
  - Regimen (#injections): number of vaccinations participant received
    as part of study.
  - CD\[4/8\]+: NOOOOOOOOOOOOOOOOOT SUUUUUUUUUUUUUUUUUUUURE.
  - CD\[4/8\]+:CD\[4/8\]g-T-2-17-
    - Frequencies of cell subsets.
    - CD\[4/8\]+ indicates whether cells are CD4 or CD8 T cells.
    - ‘2’ corresponds to IL-2, ‘17’ to IL-17, ‘G’ to IFN$\gamma$ and ‘T’
      to TNF. A ‘+’ indicates that the preceding cytokine was produced,
      and a ‘-’ that it was not.
- Responses background subtracted?
  - No
...
- Columns
  ...
  - RANDOMISATION
    - Whether or not a vaccine or placebo was given to the participant.
    - ‘ID93+GLA/SE’ means that the participant was given a vaccine, and
      ‘Placebo’ that the participant was given a placebo.
  - QFT Status
    - Mycobacterium tuberculosis infection status according to a
      quantiferon cut-off of 0.35 at time of first vaccination.
...
- Columns
  ...
  - SubjectType
    - Mycobacterium tuberculosis infection status according to a
      quantiferon cut-off of 0.35 at time of first vaccination.
    - All subjects have value ‘LTBI’ for this column, meaning that their
      quantiferon score was greater than 0.35.
    - Stimulation: stimulation condition.
  - CD4.Gneg2negTpos…Count to CD8.Gpos2posTneg…Freq..of.Parent
    ...
    - ‘2’ corresponds to IL-2, ‘17’ to IL-17, ‘G’ to IFN$\gamma$ and ‘T’
      to TNF. A ‘pos’ indicates that the preceding cytokine was
      produced, and a ‘neg’ that it was not.
- Responses background subtracted?
  - No
